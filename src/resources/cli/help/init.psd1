@{
    ...
    Examples = @(
        @{
            Command = 'nova init'
            Description = 'Start the interactive scaffold flow with immediate inline retry for invalid answers and the optional Agentic Copilot starter prompt.'
        },
        @{
        ...
        @{
            ...
            Description = 'Create the packaged example scaffold at an explicit destination with the same inline validation behavior and optional Agentic Copilot starter prompt.'
        }
    )
}
