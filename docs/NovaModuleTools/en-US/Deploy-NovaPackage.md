...
`Deploy-NovaPackage` uploads existing package artifacts that were generated by `Merge-NovaModule`.
...
Use `Merge-NovaModule` first when you want NovaModuleTools to generate the package artifacts before upload.
...
- https://github.com/stiwicourage/NovaModuleTools/blob/main/docs/NovaModuleTools/en-US/Merge-NovaModule.md
