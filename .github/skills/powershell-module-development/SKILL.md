...
- Add or update valid PlatyPS-compatible help under `docs/NovaModuleTools/en-US/` when public commands or public classes change. Use this order:
	1. Build the module with `Invoke-NovaBuild`.
	2. Import the built module with `Import-Module ./dist/NovaModuleTools/NovaModuleTools.psd1 -Force`.
...
- Run `tests/ArchitectureGuardrails.Tests.ps1` for any structural change, including new files, renamed files, or changed function names.
